...
const checkBlocked = require('../check-blocked') // Blocked user check
...
// CREATING POST
router.post('/', checkAuth, checkBlocked, upload.array('postMedia'), postController.add_post);
...
// LIKING POST
router.post('/:postId/like', checkAuth, checkBlocked, postController.like_post);

// UNLIKING POST
router.delete('/:postId/like', checkAuth, postController.unlike_post);

// ADDING COMMENT
router.post('/:postId/comment', checkAuth, checkBlocked, postController.add_comment);
